...
- **Runway** · `runwayml` · Editorial film-festival aesthetic, cinematic dark heroes, black pill CTAs
...
- **Warp** · `warp` · Dark IDE-like terminal, block-based command UI
...
- **Sanity** · `sanity` · Dark editorial marketing, 112px display type, coral-red accent
- **Sentry** · `sentry` · Dark, data-dense dashboard, pink-purple accent
...
- **Slack** · `slack` · Present in the repo (not in the upstream README index); workplace-messaging brand
...
- **Starbucks** · `starbucks` · Four-tier earth-green system, warm cream canvas, SoDoSans
...
- **PlayStation** · `playstation` · Three-surface channel layout, cyan hover-scale
...
- **BMW M** · `bmw-m` · Motorsport contrast, M color accents, precision-driven
- **Bugatti** · `bugatti` · Cinema-black canvas, monochrome austerity, monumental display
- **Ferrari** · `ferrari` · Chiaroscuro editorial, Ferrari Red with extreme sparseness
- **Lamborghini** · `lamborghini` · True-black cathedral, gold accent, LamboType Neo-Grotesk
- **Renault** · `renault` · Vivid aurora gradients, NouvelR typeface, zero-radius buttons
- **Tesla** · `tesla` · Radical subtraction, full-viewport photography, Universal Sans
